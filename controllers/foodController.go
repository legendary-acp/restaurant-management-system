...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		projectStage := bson.D{
			{"$project", bson.D{
				{"_id", 0},         // 0 Means field hidden in output
				{"total_count", 1}, // 1 Means presented in output
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error ooccured while listing food items"})
		}
		var allFoods []bson.M
